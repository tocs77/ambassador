...
import { useGetUser, useUpdatePassword, useUpdateUser } from '@/entities/User';

export const ProfilePage = () => {
  const { data: user, isLoading, error: loadError } = useGetUser();
  const [updateUser, { error: updateUserError }] = useUpdateUser();
  const [updatePassword, { error: updatePasswordError }] = useUpdatePassword();
